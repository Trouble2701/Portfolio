    ...
    [
      {
        ...
        whoIam: [
          ...
          ' Jahre. Ich bin ein Frontend-Entwickler und wohnen in Dresden. Motiviert durch die grenzenlosen Möglichkeiten innerhalb der IT freue ich mich darauf, visuell fesselnde und intuitive Websites und Anwendungen zu erstellen.',
        ...
        technologies: [
          'Technologien',
          'Fähigkeiten',
          'Auf meinem Weg bei der Developer Akademie habe ich umfassende Arbeit an verschiedenen Projekten und den Einsatz verschiedener Frontend-Technologien und -Konzepten erlernt. Ich bin offen für den Einsatz neuer Technologien und Methoden, um meine Fähigkeiten kontinuierlich zu verbessern und in der sich ständig weiterentwickelnden Landschaft der Webentwicklung an der Spitze zu bleiben.',
          'Ich habe Ihr',
          'Interesse geweckt?',
